...
- [ ] Name + tagline: “FirstBuck — Micro-offers from rough ideas”
- [ ] Gallery: landing, form, results, unlock
- [ ] Maker comment ready (story + ask)
- [ ] 5 hunters lined up the night before
- [ ] Reply to every comment in first 6 hours
- [ ] Link Stripe-live production URL + custom domain

## Reply templates

**“How is this different from ChatGPT?”**  
Productized flow, stable structure, unlockable pack, Markdown export, and a launch checklist aimed at a first sale in 24h — not a chat transcript.

**“Can I use this for consulting offers?”**  
Yes — set status to WIP/shipped and name your audience. The pack still pushes toward a tiny digital/listable wedge.

**“Do you train on my ideas?”**  
No model training pipeline. Generation runs on a deterministic template engine (optional OpenAI polish only if configured). We don’t sell your prompts.
